...
const DEFAULT_CONTENT_CLASSNAME =
  "mx-auto flex max-w-6xl flex-col gap-8 px-8 pb-16 pt-10 sm:px-10 lg:px-12";
  ...
  return (
    <>
      <header className="border-b border-slate-200 bg-white/80 py-4 shadow-sm backdrop-blur supports-[backdrop-filter]:bg-white/60">
        <div className="mx-auto flex max-w-6xl flex-col gap-4 px-8 sm:flex-row sm:items-center sm:justify-between sm:px-10 lg:px-12">
