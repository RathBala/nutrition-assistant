...
const LoggedMealCard = ({ meal }: { meal: TodayMealLog }) => (
  <article className="grid gap-4 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md md:grid-cols-[112px_1fr]">
    ...
    <div className="flex flex-col justify-between gap-3">
      <header className="flex flex-col gap-2 md:flex-row md:items-start md:justify-between">
        <div>
          <p className="text-xs font-semibold uppercase tracking-wide text-brand-dark">{meal.slotName}</p>
      ...
      <p className="text-sm text-slate-600">
        Nutrition analysis will appear here after your meal is processed.
      </p>
